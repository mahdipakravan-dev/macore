...
module.exports = function () {
    inquirer
        ...
        .then(function (answers) {
            ...
            console.log(pad(chalk.grey('Coffee type: '), 30), answers.coffeType);
            console.log(pad(chalk.grey('Sugar level: '), 30), answers.sugarLevel);
            console.log(pad(chalk.grey('Decaf: '), 30), answers.decaf);
            console.log(pad(chalk.grey('Cold: '), 30), answers.cold);
            console.log(pad(chalk.grey('Served in: '), 30), answers.servedIn);
            console.log(pad(chalk.grey('With stirrer: '), 30), answers.stirrer);
